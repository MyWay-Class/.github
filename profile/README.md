<p align="center">
  <img src="./banner.svg" alt="내맘대로클래스 배너" />
</p>
...
`내맘대로클래스`는 기본 LMS 위에 AI 레이어를 더해, 강의 콘텐츠를 더 짧고, 더 개인화되고, 더 재사용 가능한 형태로 바꾸는 차세대 교육 솔루션입니다.
...
`내맘대로클래스`는 이 문제를 AI로 풀기 위해 시작된 프로젝트입니다.
