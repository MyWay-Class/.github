...
- 작업 전에는 목적, 대상, 완료 기준을 먼저 고정합니다
- 지시는 짧게 쓰되, 범위와 참조 문서는 분명히 씁니다
- 분석 요청은 파일명과 라인 번호를 함께 적습니다
...
- 같은 이슈에 대해 필요할 때만 2안까지 비교합니다
- 비교 기준은 변경량, 파일 수, 검증 결과, 구조 적합성입니다
- 결과는 바로 채택하지 않고 문서와 코드가 일치하는지 다시 봅니다
- 비교가 끝나면 선택 이유를 `docs/dev-logs/`에 기록합니다
